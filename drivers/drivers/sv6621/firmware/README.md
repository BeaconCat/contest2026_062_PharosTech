...
vendor. They are stored verbatim, embedded in the firmware image with
`.incbin`, and passed unchanged to the SV6621 firmware loader. They are not
derived from the Apache-licensed driver source.
