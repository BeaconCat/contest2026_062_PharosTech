...
__asm__(
  ...
  "g_skw_nv_start:\n"
  "  .incbin \"/root/openvela/sv6621-ab-f9a/board/firmware/SWT6621S_NV_SDIO_ALONE.bin\"\n"
  "  .global g_skw_nv_end\n"
  "g_skw_nv_end:\n"
  "  .align 4\n"
  "  .global g_skw_calib_start\n"
  "g_skw_calib_start:\n"
  "  .incbin \"/root/openvela/sv6621-ab-f9a/board/firmware/SWT6621S_SEEKWAVE_R00001.bin\"\n"
...
static void kickpi_k7_wifi_enable_32k(void)
{
  ...
  for (attempt = 0; attempt < 6; attempt++)
    {
      ...
      up_mdelay(3);
      I2C_TRANSFER(i2c, &pmsg, 1);
      I2C_TRANSFER(i2c, &dmsg, 1);
      if (wr == 0 && rback == 0xc4)
        {
          break;
        }
...
static const struct rk3576_skw_board_s g_kickpi_k7_wifi_board =
{
