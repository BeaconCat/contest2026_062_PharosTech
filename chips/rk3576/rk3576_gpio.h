 ...
 * Description:
 *   Attach a kernel
 * interrupt handler to a configured GPIO interrupt pin.
 *   Delivery remains
 * masked until rk3576_gpio_irq_enable() is called.
 *
 ...
 * Description:
 *   Enable or disable
 * interrupt delivery for a kernel-owned GPIO pin.
 *
 ...
 * Description:
 *   Disable a
 * kernel-owned GPIO interrupt and release its handler slot.
 *
