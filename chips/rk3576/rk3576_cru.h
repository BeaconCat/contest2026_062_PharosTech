 ...
 *
 * Description:
 *   Enable the clock and reset of the SDIO controller (mmc@2a320000) and
 *   return the actual cclk_src_sdio frequency (Hz) for the host driver to
 *   use as its CLKIN.  See rk3576_cru.c for details.
 *
 ****************************************************************************/
