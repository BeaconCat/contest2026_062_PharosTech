/****************************************************************************
 * vendor/rockchip/chips/rk3576/hardware/rk3576_pdm.h
 *
...
#define PDM_CTRL0_VDW(n)        ((((n) - 1) << PDM_CTRL0_VDW_SHIFT) & \
                                 PDM_CTRL0_VDW_MASK)
...
#define PDM_CTRL1_FILTER_GAIN(n)    (((n) << PDM_CTRL1_FILTER_GAIN_SHIFT) & \
                                     PDM_CTRL1_FILTER_GAIN_MASK)
...
#define PDM_DMA_CTRL_RDL(n)    ((((n) - 1) << PDM_DMA_CTRL_RDL_SHIFT) & \
                                PDM_DMA_CTRL_RDL_MASK)
